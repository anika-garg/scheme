...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        #if symbol in list(self.bindings):
...
class LambdaProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # BEGIN PROBLEM 12
        new = self.env.make_child_frame(self.formals, args)
        return new
        # END PROBLEM 12
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        # BEGIN PROBLEM 6
        result = scheme_eval(expressions.second.first, env)
...
def make_let_frame(bindings, env):
    ...
    while bindings:
        ...
        value = scheme_eval(pair.second.first, env)
...
class MuProcedure(Procedure):
    ...
    # BEGIN PROBLEM 16
    def make_call_frame(self, args, env):
        new = env.make_child_frame(self.formals, args)
        return new
    # END PROBLEM 16
